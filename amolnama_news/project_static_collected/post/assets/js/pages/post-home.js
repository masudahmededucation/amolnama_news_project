...
(function () {
  ...
  if (composerElement) {
    ...
    function isComposerInDraftMode() {
      ...
      if (postComposerEmojiPickerInstance && postComposerEmojiPickerInstance.isOpen()) return true;
      let textarea = composerElement.querySelector('.post-composer-textarea');
  ...
  var postComposerEmojiPickerInstance = null;
  ...
  if (emojiButton && emojiPickerElement && composerTextarea && window.emojiPicker) {
    postComposerEmojiPickerInstance = window.emojiPicker.attach({
      toggleButton: emojiButton,
      pickerContainer: emojiPickerElement,
      targetTextarea: composerTextarea,
      mode: 'full',
      idPrefix: 'post-composer'
    });
  }
