DELETE FROM [bangladesh].[ref_destination_category];
DELETE FROM [bangladesh].[ref_season];
DELETE FROM [bangladesh].[ref_media_category];

SET IDENTITY_INSERT [bangladesh].[ref_destination_category] ON;
INSERT INTO [bangladesh].[ref_destination_category] (bangladesh_ref_destination_category_id, destination_category_code, destination_category_name_en, destination_category_name_bn, sort_order) VALUES
...
INSERT INTO [bangladesh].[ref_season] (bangladesh_ref_season_id, season_code, season_name_en, season_name_bn, season_months, sort_order) VALUES
...
INSERT INTO [bangladesh].[ref_media_category] (bangladesh_ref_media_category_id, media_category_code, media_category_name_en, media_category_name_bn, sort_order) VALUES
