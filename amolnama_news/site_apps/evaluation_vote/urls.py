...
urlpatterns = [
    ...
    path('past-results/<int:evaluation_id>/', views.past_election_results_drillthrough_location, name='past_election_results'),
    path('api/evaluation/', views.get_evaluation, name='get_evaluation'),
    ...
    path('api/vote-cast-current-results/', views.vote_cast_current_results, name='vote_cast_current_results'),
