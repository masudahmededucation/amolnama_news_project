...
class EntertainmentFormFact(models.Model):
    ...
    prod_title_name                          = models.CharField(max_length=500)  # NOT NULL
    ...
    prod_director                            = models.CharField(max_length=100, blank=True, null=True)
    prod_producer_house                      = models.CharField(max_length=100, blank=True, null=True)
    prod_writer_screenwriter                 = models.CharField(max_length=100, blank=True, null=True)
    prod_music_director_singer               = models.CharField(max_length=100, blank=True, null=True)

    # Step 5: Cast & Release (কাস্ট ও মুক্তি)
    cast_lead_cast                           = models.CharField(max_length=2000, blank=True, null=True)
    cast_supporting_cast                     = models.CharField(max_length=2000, blank=True, null=True)
    ...
    perf_box_office_revenue                  = models.CharField(max_length=100, blank=True, null=True)
    perf_views_streams                       = models.CharField(max_length=100, blank=True, null=True)
    perf_rating                              = models.CharField(max_length=100, blank=True, null=True)
