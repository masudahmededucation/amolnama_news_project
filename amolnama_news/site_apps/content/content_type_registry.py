...
CONTENT_TYPE_REGISTRY = {
    ...
    'biography': {
        ...
        'color':                 'purple',
        'cta':                   'পড়ুন',
        'model_module':          'amolnama_news.site_apps.biography.models',
        'model_name':            'CollBiographyEntry',
        'table_schema':          'blog_biography',
        'table_name':            'coll_biography_entry',
        'pk_field':              'blog_biography_coll_biography_entry_id',
        'title_bn_field':        'biography_entry_title_bn',
        'title_en_field':        'biography_entry_title_en',
        'slug_field':            'biography_entry_slug',
        'summary_bn_field':      'biography_entry_short_description_bn',
        'summary_en_field':      'biography_entry_short_description_en',
        'is_published_field':    'is_published',
        'is_active_field':       'is_active',
        'is_featured_field':     'is_featured',
        'status_code_field':     'biography_entry_status_code',
        'bookmark_count_field':  'bookmark_count',
        'like_count_field':      'like_count',
        'view_count_field':      'view_count',
        'comment_count_field':   'comment_count',
        'detail_url_prefix':     '/jibonkotha/',
        'category_group_code':   'blog_biography_category',
        'secondary_group_code':  None,
    },
    ...
    'history_bd': {
        ...
        'color':                 'amber',
        'cta':                   'জানুন',
        'model_module':          'amolnama_news.site_apps.historybd.models',
        'model_name':            'CollHistoryEvent',
        'table_schema':          'blog_historybd',
        'table_name':            'coll_history_event',
        'pk_field':              'blog_historybd_coll_history_event_id',
        'title_bn_field':        'history_event_title_bn',
        'title_en_field':        'history_event_title_en',
        'slug_field':            'history_event_slug',
        'summary_bn_field':      'history_event_short_description_bn',
        'summary_en_field':      'history_event_short_description_en',
        'is_published_field':    'is_published',
        'is_active_field':       'is_active',
        'is_featured_field':     'is_featured',
        'status_code_field':     'history_event_status_code',
        'bookmark_count_field':  'bookmark_count',
        'like_count_field':      'like_count',
        'view_count_field':      'view_count',
        'comment_count_field':   'comment_count',
        'detail_url_prefix':     '/itihas/',
        'category_group_code':   'blog_historybd_era',
        'secondary_group_code':  None,
    },
}
