...
(function () {
  ...
  var submitForm = document.getElementById('stories-submit-form');
  var submitButton = document.getElementById('stories-submit-button');
  var errorMessage = document.getElementById('stories-submit-error-message');
