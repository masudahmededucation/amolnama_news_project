...
class CollTopic(models.Model):
    ...
    blue_side_video_url = models.CharField(max_length=500, blank=True, null=True)
    red_side_video_url = models.CharField(max_length=500, blank=True, null=True)
    blue_side_image_url = models.CharField(max_length=500, blank=True, null=True)
    red_side_image_url = models.CharField(max_length=500, blank=True, null=True)
