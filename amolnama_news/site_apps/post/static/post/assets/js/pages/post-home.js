      ...
      .then(function (data) {
        ...
        if (data.success) {
          ...
          var newPostHtml = '<article class="post-card" id="post-card-' + data.post_post_id + '" data-post-id="' + data.post_post_id + '">'
            ...
            + '<button type="button" class="post-card-quick-edit-button" id="post-card-quick-edit-' + data.post_post_id + '" name="post_card_quick_edit_' + data.post_post_id + '" data-post-id="' + data.post_post_id + '" data-post-text="' + escapeHtmlText(postText) + '" title="সম্পাদনা (Edit)">✏️</button>'
            ...
            + '<button type="button" class="post-card-more-menu-item post-card-analytics-button" id="post-card-analytics-' + data.post_post_id + '" name="post_card_analytics_' + data.post_post_id + '" data-post-id="' + data.post_post_id + '" data-views="0" data-likes="0" data-replies="0" data-reposts="0">📊 Analytics</button>'
            + '<button type="button" class="post-card-more-menu-item post-card-pin-button" id="post-card-pin-' + data.post_post_id + '" name="post_card_pin_' + data.post_post_id + '" data-post-id="' + data.post_post_id + '">📌 Pin Post</button>'
