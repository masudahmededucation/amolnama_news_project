...
class RefCoverPalette(models.Model):
    ...
    cover_palette_bg_hex = models.CharField(max_length=10)
    cover_palette_fg_hex = models.CharField(max_length=10)
...
class BookCoverDesign(models.Model):
    ...
    cover_palette_bg_hex_override = models.CharField(max_length=10, null=True, blank=True)
    cover_palette_fg_hex_override = models.CharField(max_length=10, null=True, blank=True)
