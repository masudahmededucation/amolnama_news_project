...
class CrimeFormImpactCasualty(models.Model):
    ...
    property_destruction_description = models.TextField(blank=True, null=True)
...
class ConflictFormActorCountry(models.Model):
    ...
    actor_alliance_coalition = models.CharField(max_length=255, blank=True, null=True)
    actor_leader_decision_maker = models.CharField(max_length=255, blank=True, null=True)
    actor_official_statement = models.TextField(blank=True, null=True)
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField(blank=True, null=True)
...
class ConflictFormImpact(models.Model):
    ...
    frontline_territory_name = models.CharField(max_length=255, blank=True, null=True)
    ...
    casualty_war_crime_details = models.CharField(max_length=2000, blank=True, null=True)
    global_reaction_details = models.CharField(max_length=1000, blank=True, null=True)
    ...
    local_impact_description = models.CharField(max_length=2000, blank=True, null=True)
    created_at = models.DateTimeField()
    modified_at = models.DateTimeField(blank=True, null=True)
...
class WomenFormPerpetrator(models.Model):
    ...
    perp_power_position_details = models.CharField(max_length=2000, blank=True, null=True)
    ...
    perp_history_previous_details = models.CharField(max_length=4000, blank=True, null=True)
    remarks_about_perpetrator = models.CharField(max_length=2000, blank=True, null=True)
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField(blank=True, null=True)
...
class WomenFormVictimProfileFact(models.Model):
    ...
    violence_type_describe_type_of_violence = models.CharField(max_length=500, blank=True, null=True)
    ...
    victim_condition_disability_type = models.CharField(max_length=100, blank=True, null=True)
    # Step 5: Injury
...
class PriceHikingFormCommodityPrice(models.Model):
    ...
    consumer_impact_description = models.CharField(max_length=1000, blank=True, null=True)
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField(blank=True, null=True)
...
class PriceHikingFormCommodityStockSupplyChain(models.Model):
    ...
    stock_storage_description = models.CharField(max_length=500, blank=True, null=True)
    stock_estimated_quantity = models.CharField(max_length=100, blank=True, null=True)
    supply_chain_crisis_description = models.CharField(max_length=500, blank=True, null=True)
    created_at = models.DateTimeField()
    modified_at = models.DateTimeField(blank=True, null=True)
